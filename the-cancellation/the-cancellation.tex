...
The full formalization spans $\approx$150 Lean~4 files and $\approx$66{,}000 lines,
with axiom-free proofs for the core results and 7 axioms encoding the
deep modularity and level-lowering theorems (Wiles/BCDT, Jacquet--Langlands, Shimura curve descent).
...
\noindent
Totals: $\approx$150 files, $\approx$66{,}000 lines across the full formalization
(4{,}543 build jobs, build clean as of 2026-03-22).
...
7~axioms encoding Wiles/BCDT modularity (\texttt{frey\_octic\_modular}),
Jacquet--Langlands transfer (\texttt{jl\_special\_transfer}),
Shimura curve level lowering (\texttt{quaternionic\_level\_lowering},
\texttt{level\_strip\_one\_prime}), and conductor divisibility
(\texttt{two\_always\_divides\_frey\_conductor},
\texttt{three\_divides\_frey\_conductor},
\texttt{cyclotomic\_trivial\_on\_inertia\_equal}).
...
The 7~axioms are confined to the Quaternionic Wiles Program infrastructure
(Section~\ref{sec:qwiles}), where they encode theorems whose Lean~4
