# Kagami Orb V3.1 — Thermal Analysis (SEALED DESIGN)
...
| **1.39" AMOLED** | Top | 0.3 | 0.8 | 1.2 | King Tech RM69330 |
| **HD108 LEDs ×16** | Equator | 0.2 | 0.8 | 1.6 | 16-bit at full white |
| **Other** | Distributed | 0.7 | 1.7 | 2.9 | Sensors, ESP32, XMOS, misc |
| **TOTAL** | | **6.7** | **13.8** | **22.7** | |

**Note:** Totals aligned with SPECS.md (single source of truth). Peak power (22.7W) still exceeds passive cooling capacity.
...
- Aligned thermal budget with SPECS.md (6.7W/13.8W/22.7W)
- Updated display reference to 1.39" AMOLED
