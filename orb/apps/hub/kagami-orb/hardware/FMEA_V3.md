# Kagami Orb V3.1 — Failure Mode and Effects Analysis (FMEA)
...
| **Date** | 2026-01-11 |
| **Status** | Draft |
| **Design Reference** | HARDWARE_BOM.md V3.1 |
...
| ID | Failure Mode | Effect | S | O | D | RPN | Mitigation | Residual RPN |
|----|--------------|--------|---|---|---|-----|------------|--------------|
| CR-12 | Round display sourcing instability | Inconsistent supply; quality variance | 6 | 5 | 4 | 120 | Qualify 2-3 suppliers (1.39" AMOLED); incoming inspection; define acceptance criteria | 60 |
...
| Display | King Tech 1.39" AMOLED RM69330 | Multiple suppliers | LOW |
