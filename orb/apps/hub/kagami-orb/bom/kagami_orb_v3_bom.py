...
MANUFACTURING_PARTNERS = [
    ...
    },
    {
        ...
        "cost": "Free setup",
        "contact": "pcbway.com",
        "notes": "Free SMT stencil",
    },
    {
        "stage": "PCBA (Pilot)",
        "partner": "Seeed Fusion",
        "location": "China",
        "moq": "10",
        "lead_time": "7-10 days",
        "cost": "$0.50/joint",
        "contact": "seeedstudio.com",
        "notes": "Good DFM support",
    },
    {
        "stage": "PCBA (Production)",
        "partner": "MacroFab",
        "location": "USA",
        "moq": "100",
        "lead_time": "10-15 days",
        "cost": "$0.02/joint",
        "contact": "macrofab.com",
        "notes": "US-based, turnkey",
    },
    {
        "stage": "PCBA (Production)",
        "partner": "Tempo Automation",
        "location": "USA",
        "moq": "10",
        "lead_time": "3-5 days",
        "cost": "Premium",
        "contact": "tempoautomation.com",
        "notes": "Fast turn, high quality",
    },
    # Box Build
    {
        "stage": "Box Build (CM)",
    ...
    },
    {
        ...
        "cost": "$3-8/unit",
        "contact": "viasion.com",
        "notes": "Consumer electronics specialist",
    },
    # Enclosure
    {
        "stage": "Enclosure (Prototype)",
        "partner": "Protolabs",
        "location": "USA",
        "moq": "1",
        "lead_time": "3-5 days",
        "cost": "$50-200/part",
        "contact": "protolabs.com",
        "notes": "SLA, MJF, SLS",
    },
    {
        "stage": "Enclosure (Production)",
        "partner": "Xometry",
        "location": "USA",
        "moq": "1",
        "lead_time": "5-10 days",
        "cost": "Instant quote",
        "contact": "xometry.com",
        "notes": "Injection tooling $3-15K",
    },
    # Specialty
    {
        "stage": "Custom Coils",
        "partner": "Vishay/Würth",
        "location": "Various",
        "moq": "1000",
        "lead_time": "4-6 weeks",
        "cost": "$0.20-0.50/coil",
        "contact": "vishay.com",
        "notes": "Litz wire specialty",
    },
    {
        "stage": "Certification",
        "partner": "NTS",
...
FMEA_CRITICAL = [
    {
        "component": "sensiBel SBM100B",
        "failure_mode": "Single source supplier unavailable",
        "severity": 8,
        "occurrence": 7,
        "detection": 4,
        "rpn": 224,
        "mitigation": "Dual footprint PCB for INMP441 fallback",
    },
    {
        "component": "Sony IMX989",
        "failure_mode": "Flagship sensor allocation",
        "severity": 7,
        "occurrence": 5,
        "detection": 5,
        "rpn": 175,
        "mitigation": "IMX890/IMX766 alternative qualified",
    },
    {
        "component": "Round AMOLED",
        "failure_mode": "Transparency insufficient for camera",
        "severity": 8,
        "occurrence": 4,
        "detection": 5,
        "rpn": 160,
        "mitigation": "Prototype validation required",
    },
    {
        "component": "Battery 3S",
        "failure_mode": "Thermal runaway in sealed sphere",
        "severity": 10,
        "occurrence": 2,
        "detection": 3,
        "rpn": 144,
        "mitigation": "BQ40Z50 protection, temp monitoring",
    },
    {
        "component": "Battery 3S",
        "failure_mode": "Swelling in sealed enclosure",
        "severity": 9,
        "occurrence": 2,
        "detection": 8,
        "rpn": 144,
        "mitigation": "Vent design, pressure relief",
    },
    {
        "component": "Dielectric Mirror",
        "failure_mode": "Coating delamination",
        "severity": 7,
        "occurrence": 4,
        "detection": 5,
        "rpn": 140,
        "mitigation": "Adhesion testing, supplier qualification",
    },
    {
        "component": "QCS6490",
        "failure_mode": "Thermal throttling in sphere",
        "severity": 8,
        "occurrence": 4,
        "detection": 4,
        "rpn": 128,
        "mitigation": "FEA thermal simulation $6-8K",
    },
    {
        "component": "P9415-R",
        "failure_mode": "WPT/Maglev interference",
        "severity": 7,
        "occurrence": 3,
        "detection": 5,
        "rpn": 105,
        "mitigation": "Ferrite shielding, frequency coordination",
    },
]
...
def create_bom_workbook():
    ...
    # Title
    ws_bom["A1"] = "KAGAMI ORB V3.1 - BILL OF MATERIALS"
    ws_bom["A1"].font = Font(bold=True, size=16, color="1F4E79")
    ws_bom["A2"] = f"Generated: {datetime.now().strftime('%Y-%m-%d %H:%M')}"
    ws_bom["A3"] = "Version: 3.1 | 85mm Compact SOTA with Living Eye Display"
    ...
    for comp in COMPONENTS:
        ...
        if cat not in categories:
            categories[cat] = dict.fromkeys(quantities, 0)
    ...
    ws_dash["A1"] = "KAGAMI ORB V3.1 - EXECUTIVE SUMMARY"
    ...
    metrics = [
        ...
        ("Unique Part Numbers:", len({c["part_id"] for c in COMPONENTS})),
...
def main():
    ...
    output_path = (
        "/Users/schizodactyl/projects/kagami/apps/hub/kagami-orb/bom/kagami_orb_v3_bom_model.xlsx"
    )
    wb.save(output_path)

    print(f"✓ BOM model saved to: {output_path}")
    print(f"  - Full BOM: {len(COMPONENTS)} components")
    print("  - Cost Scenarios: Qty 1, 10, 100, 500, 1000")
