# Kagami Orb V3.1 — CAD Specification

## Overview

All CAD work for the Kagami Orb V3.1 is done in **OnShape** (web-based parametric CAD).

**OnShape Document:** `Kagami Orb V3` (to be created)
**Design Version:** 3.1 — 85mm Sealed SOTA
...
| **Display Aperture** | 70mm | 1.39" AMOLED viewing area |
...
```
PURPOSE: Hold 1.39" round AMOLED + camera behind pupil
...
│                                                                                  │
│   FEATURES:                                                                      │
│   • 1.39" AMOLED recess (Ø35.41mm active, 38.8×38.2mm module)                   │
...
│   ├─────────────────┤                                                            │
│   │ 1.39" AMOLED    │  ← 454×454 round display                                  │
│   ├─────────────────┤                                                            │
...
- Corrected display spec to 1.39" AMOLED (38.8×38.2mm module)
