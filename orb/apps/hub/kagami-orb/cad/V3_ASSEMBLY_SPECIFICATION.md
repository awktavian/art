# Kagami Orb V3.1 — Complete Assembly Specification
...
**NOTE:** See `hardware/SPECS.md` for canonical mass budget and `hardware/MASS_OPTIMIZATION.md` for optimization plan.

| Category | Weight (g) |
|----------|------------|
| Shell (2 hemispheres) | 90 |
| Battery (with BMS) | 150 |
| Structural (all mounts) | 60 |
| Compute (SoM + Hailo + PCB + heatsink) | 56 |
| Display Assembly | 35 |
| Audio System | 12 |
| LED Ring | 10 |
| Power System (coil + ferrite + ICs) | 38 |
| **Current Total** | **391g** |
| Target Mass | 350g |
| **Optimization Needed** | **-41g** |
| Maglev Capacity | 500g |

**Mass optimization required.** See `hardware/MASS_OPTIMIZATION.md` for detailed optimization strategies. |
...
3. Wind RX coil (70mm, 20 turns Litz, 45μH) into mount
...
**NOTE:** See `hardware/SPECS.md` for canonical thermal budget.

### 5.1 Heat Sources

**TDP vs Actual Power Consumption:**
The table below shows TDP (thermal design power) ratings. Actual power varies by operating mode.

| Component | TDP (W) | Idle (W) | Active (W) | Peak (W) | Max Temp |
|-----------|---------|----------|------------|----------|----------|
| QCS6490 SoM | 4.0 | 5.0 | 8.0 | 12.0 | 85°C |
| Hailo-10H | 2.5 | 0.5 | 2.5 | 5.0 | 80°C |
| Display | 0.5 | 0.3 | 0.8 | 1.2 | 70°C |
| LEDs (×16) | 0.8 | 0.2 | 0.8 | 1.6 | 65°C |
| Other | 1.5 | 0.7 | 1.7 | 2.9 | — |
| **Total** | **9.3** | **6.7** | **13.8** | **22.7** | |

**Operating Mode Power Budget:**
- **Idle:** 6.7W (display off, listening)
- **Active:** 13.8W (display + AI + audio)
- **Peak:** 22.7W (all systems max, transient only)
...
| 3.1.1 | Jan 2026 | Reconciled with SPECS.md: Fixed RX coil (45μH not 85μH), updated mass budget (391g), added thermal budget by mode |
...
| Document | Purpose |
|----------|---------|
| `hardware/SPECS.md` | **CANONICAL** specifications source |
| `hardware/I2C_ADDRESS_MAP.md` | I2C bus topology and addresses |
| `hardware/MASS_OPTIMIZATION.md` | Mass reduction strategies |
| `hardware/THERMAL_ANALYSIS.md` | Detailed thermal modeling |
| `hardware/VERIFIED_BOM_V3.1.md` | Bill of materials |
