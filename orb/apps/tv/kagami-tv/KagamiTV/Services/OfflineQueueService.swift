//
// OfflineQueueService.swift -- File-Based Offline Queue for tvOS
//
...
/// File-based offline queue service for tvOS
...
public final class OfflineQueueService: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.kagami.tv", category: "OfflineQueue")
    ...
    private var queueFilePath: URL {
        cachesDirectory.appendingPathComponent("offline_queue.json")
    }

    private var stateFilePath: URL {
        cachesDirectory.appendingPathComponent("offline_state.json")
    }
    ...
    private init(networkService: KagamiNetworkService = .shared) {
    ...
    private func setupConnectivityObserver() {
        ...
        KagamiAPIService.shared.$isConnected
            .removeDuplicates()
    ...
    public func syncPendingActions() async -> SyncResult {
        ...
        guard KagamiAPIService.shared.isConnected else {
        ...
        for var action in actionsToProcess {
            ...
            if success {
                ...
                if KagamiAPIService.shared.isCircuitOpen {
    ...
    private func executeActionDirectly(
        ...
        let baseURL = KagamiAPIService.shared.currentBaseURL
