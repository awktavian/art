...
==============================
This module has been split into logical submodules for better organization.
All imports are re-exported here for backward compatibility.

New structure:
- kagami.math.clebsch_gordan.coefficients: Root system generation
- kagami.math.clebsch_gordan.projections: Projection matrix computation
- kagami.math.clebsch_gordan.hierarchies: Hierarchy classes
- kagami.math.clebsch_gordan.dual_projector: G2 dual projector

All existing imports from this module will continue to work unchanged.
...
# Re-export everything from the new submodules for backward compatibility
from kagami_math.clebsch_gordan import (
    E6ToF4TrueProjector,
    E7ToE6TrueProjector,
    E8AdjointBasis,
    E8ToE7TrueProjector,
...
# Maintain the original __all__ for backward compatibility
__all__ = [
    "E6ToF4TrueProjector",
    "E7ToE6TrueProjector",
    "E8AdjointBasis",
