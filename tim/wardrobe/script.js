...
(function() {
    ...
    function initNavHearts() {
        // Check if nav-hearts already exists in HTML (for mobile accessibility)
        let heartsNav = document.querySelector('.nav-hearts');
        
        if (heartsNav) {
            // Button exists in HTML - just update count and add handler
            const countEl = heartsNav.querySelector('.nav-hearts-count');
            if (countEl) {
            ...
            heartsNav = document.createElement('button');
