/**
 * Design Tokens for Three.js (art XR adapter)
 * ============================================
 *
 * Public brand canonical: projects/awkronos-waddle/packages/design-tokens
 *   (@awkronos/design-tokens + tokens.json). Colony hexes here must match
 *   that tokens.json colors.colony.* — do not fork a second tokens.json.
 *
 * This file is the art-local Three.js adapter (num/rgb helpers). Patent
 * portfolio should import from here instead of inlining COLONY_COLORS
 * (see patent-portfolio/DEBT-design-tokens.md).
 *
