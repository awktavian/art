 ...
 *
 * ═══════════════════════════════════════════════════════════════════════════
 * MUSICAL COMPOSITION NOTES
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * These leitmotifs follow Wagnerian tradition — recurring musical phrases
 * that represent concepts and emotions. Each sound carries emotional weight.
 *
 * LEITMOTIF 1: "Curiosity" (hover)
 * ────────────────────────────────
 * Artistic Intent: The moment of discovery, like a butterfly landing.
 * Score: Am7 chord (A-C-E-G) on Celeste + Harp pizzicato
 * Tempo: ♩ = 80 BPM, rubato
 * Dynamics: pp with gentle swell (CC1: 45→55→45)
 * Emotion: MYSTERIOUS
 *
 * LEITMOTIF 2: "Affirmation" (click)
 * ──────────────────────────────────
 * Artistic Intent: The decisive moment — commitment to action.
 * Score: French horns attack, pitch-shifted from welcome
 * Tempo: ♩ = 120 BPM
 * Dynamics: mf→f→mp quick arc
 * Emotion: SERENE with confidence
 *
 * LEITMOTIF 3: "Atmosphere" (ambient)
 * ───────────────────────────────────
 * Artistic Intent: Constant presence, like sunlight through a window.
 * Score: Full orchestra low-passed pad, half-speed
 * Tempo: ♩ = 40 BPM (derived)
 * Dynamics: ppp (15% volume, background)
 * Emotion: SERENE, unobtrusive
 *
 * LEITMOTIF 4: "Welcome" (welcome)
 * ────────────────────────────────
 * Artistic Intent: Grand arrival — "I see you, welcome home."
 * Score: G major chord — Horns (G3, D4) + Violins (B4, G5) + Celli (G2)
 * Tempo: ♩ = 72 BPM
 * Dynamics: Heroic swell (CC1: 70→90→60)
 * Emotion: HEROIC
 *
 * See: COMPOSITION.md for full score and rendering pipeline.
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * Features:
